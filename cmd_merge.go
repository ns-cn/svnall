...
存放仓库最近10次提交到指定目录： snvall merge -b ./code/svn -t ./update-20220818 -l 10
合并指定分支版本到另外多个分支： svnall merge -b ./code/svn -t ./branch1 -t ./branch2 -r 1024
合并仓库指定版本区间的提交到另外一个分支： svnall merge -b ./code/svn -r 1024:2048 -t ./branch1
